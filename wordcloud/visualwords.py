...
mask = np.array(Image.open('assets/cat.png'))
mask = np.where(mask == 0, 0, 255)

with open('./assets/jp.txt', 'r', encoding='utf-8', errors='ignore') as f:
    text = f.read()
...
wordcloud.to_file("./result/jp-cat.png")